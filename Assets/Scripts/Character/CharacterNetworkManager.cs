...
public class CharacterNetworkManager : NetworkBehaviour
{
    ...
    public void CheckHP(int oldValue, int newValue)
    {
        ...
        {
            StartCoroutine(character.HandleDeathEvent());
        }
    ...
    // A SERVER RPC IS A FUNCTION CALLED FROM A CLIENT, TO THE HOST
    [ServerRpc]
        ...
        float contactPointZ)
    {
        if (IsServer)
        {
            NotifyTheServerOfCharacterDamageClientRpc(damagedCharacterID, characterCausingDamageID, physicalDamage, magicDamage, fireDamage, holyDamage, poiseDamage, lightningDamage, angleHitFrom, contactPointX, contactPointY, contactPointZ);
        }
    }
    ...
    public void NotifyTheServerOfCharacterDamageClientRpc(
        ...
        float contactPointZ)
    {
        ProcessCharacterDamageFromServer(damagedCharacterID, characterCausingDamageID, physicalDamage, magicDamage, fireDamage, holyDamage, poiseDamage, lightningDamage, angleHitFrom, contactPointX, contactPointY, contactPointZ);
    }
        ...
        float contactPointZ)
    {
        ...
        damageEffect.magicDamage = physicalDamage;
