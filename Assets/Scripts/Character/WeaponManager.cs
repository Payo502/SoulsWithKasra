...
public class WeaponManager : MonoBehaviour
{
    ...
    public void SetWeaponDamage(CharacterManager characterHoldingWeapon, WeaponItem weapon)
    {
        meleeDamageCollider.characterCausingDamage = characterHoldingWeapon;
        meleeDamageCollider.physicalDamage = weapon.physicalDamage;
        meleeDamageCollider.magicDamage = weapon.magicDamage;
        meleeDamageCollider.fireDamage = weapon.fireDamage;
        meleeDamageCollider.lightingDamage = weapon.lightningDamage;
